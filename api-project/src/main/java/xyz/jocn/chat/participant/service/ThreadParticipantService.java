...
public class ThreadParticipantService {
	...
	@Transactional
	public void join(ThreadJoinRequestDto dto) {
		...
		RoomParticipantEntity roomParticipantEntity = roomParticipantRepository
			.findByIdAndUserId(threadEntity.getRoom().getId(), dto.getUserId())
	...
	public List<ThreadParticipantDto> fetchThreadParticipants(Long threadId) {
